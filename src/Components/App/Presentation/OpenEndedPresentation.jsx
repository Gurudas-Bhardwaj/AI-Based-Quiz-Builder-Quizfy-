...
const OpenEndedPresentation = () => {

    const location = useLocation();
    const backgroundImage = location.state?.backgroundImage;

    const [question,setQuestion] = useState("What is Your Favorite Food?")
    const [option1,setOption1] = useState("Pizza");    
    const [option2,setOption2] = useState("Burger");
    const [option3,setOption3] = useState("Sushi");
    const [option4,setOption4] = useState("Tacos");
                                    ...
                                    <div className='w-full flex justify-center mt-4 items-center h-[77%]'>
                                        <div className='w-[100%] pl-3 pr-3 overflow-auto grid grid-cols-4 place-items-start gap-4 h-full'>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 1 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 2 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 3 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 4 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 5 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 6 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 7 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 8 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 9 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 10 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 11 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 12 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 13 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 14 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 15 Response</p>
                                            </div>
                                            <div className='w-full border border-black bg-indigo-400 flex justify-center font-Outfit items-center'>
                                                <p className='p-3    text-sm text-white'>User 15 Response</p>
                                            </div>
...
export default OpenEndedPresentation