...
const RankingType = ({question, options, designTemplate}) => {
        ...
        const [colorPicker1, setColorPicker1] = useState("#305bab");
        const [colorPicker2, setColorPicker2] = useState("#fe9f4d");
        const [colorPicker3, setColorPicker3] = useState("#659df2");
        const [colorPicker4, setColorPicker4] = useState("#067429");
                                        ...
                                        <div className='w-[90%] font-Outfit flex flex-col justify-start pt-5 gap-4 '>
                                            ...
                                            <div key={key._id} className='w-full  flex gap-1'>
                                                ...
                                                <div className='w-[70%] md:w-[90%] flex gap-2'>
                                                    <div className='w-[1%] h-full' style={{ backgroundColor: colorPicker1 }}></div>
                                                    <div>{key.text}</div>
                                                </div>
                                            </div>
                                            ))}
                                ...
                                <div className='bg-white h-[370px] mt-6 border border-white rounded-2xl w-[75%] hidden lg:flex flex-col gap-6'>
                                    ...
                                    <div className='pl-3 '>
                                        ...
                                        <div className='pt-5 flex flex-col'>
                                            ...
                                            <input type="text" id='Question' className='h-7 w-[89%] border border-stone-300 bg-stone-200 focus:bg-white  focus:border-indigo-300 font-Sora pl-1 text-xs rounded-lg ' value={question} />
                                        </div>
