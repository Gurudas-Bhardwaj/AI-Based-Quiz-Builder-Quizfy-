...
import { FaComment, FaPlus, FaRegComment, FaRegUser, FaSearch } from 'react-icons/fa'
            ...
            <div className='bg-gray-200 relative h-[500px] w-screen  overflow-hidden overflow-y-hidden'>
                ...
                <div className='flex w-full h-full justify-center '>
                    <section className='w-0 lg:w-[10%]  pt-6 hidden lg:flex justify-center'>
                        <div className='flex  flex-col gap-4 items-center w-full'>
                            <button onClick={() => setNewSlideAppearence(!NewSlideAppreance)} className='flex justify-center text-[13px] gap-1 pt-2 pb-2  pr-6 pl-6 bg-stone-900 text-white cursor-pointer  items-center font-Outfit rounded-2xl'>
                                <GoPlus />
                                New Slide
                            </button>
