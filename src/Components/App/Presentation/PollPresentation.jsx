                            ...
                            <div className='flex  flex-col gap-4 items-center w-full'>
                                ...
                                <div className='w-full h-14 flex justify-center gap-2'>
                                    ...
                                    <div className='w-[80%] border flex justify-center flex-col items-center border-indigo-300 rounded-2xl h-14 gap-1' style={{
                                        backgroundImage: `url(${poll1})`, backgroundSize: 'cover', // or 'cover'
                                        backgroundPosition: 'center',}}>
                                            <PiRankingDuotone className='text-sm'/>
                                            <h1 className={`text-[7px] text font-Outfit text-${color}`}>{question}</h1>
                                    </div>
                                </div>
                            </div>
                            <div>
                        ...
                        <section className='w-[60%] flex justify-center '>
                            <div className='w-full h-full flex flex-col mt-6 items-center '>
                                ...
                                <div style={{
                                    ...
                                    backgroundPosition: 'center',
                                }} className={`h-[75%] w-[95%] text-${color}`}>
                                    <div className='w-full font-Outfit text-2xl pt-7 pl-7'>
                                        <h1>Q) {question}</h1>
                                    </div>
                                    <div className='w-full flex justify-center mt-10 items-center h-[70%]'>
                                        <div className='w-[85%] grid grid-cols-4 place-items-center gap-4 h-full'>
                                            
                                            <div className='w-full h-full font-Outfit flex flex-col justify-end pb-5 items-center'>
                                                <div>
                                                    <p>0</p>
                                                </div>
                                                <div className='bg-indigo-400 h-[20%] w-[100px]' style={{backgroundColor:colorPicker1}}></div>
                                                <div className='h-4 w-[74%] mt-1  text-white text-sm bg-black flex justify-center items-center'>
                                                    <p>{option1}</p>
                                                </div>
                                            </div>
                                            <div className='w-full font-Outfit h-full flex flex-col justify-end pb-5 items-center'>
                                                <div>
                                                    <p>0</p>
                                                </div>
                                                <div className='bg-blue-400 h-[70%] w-[100px]' style={{backgroundColor:colorPicker2}}></div>
                                                <div className='h-4 w-[74%] mt-1 text-white text-sm bg-black flex justify-center items-center'>
                                                    <p>{option2}</p>
                                                </div>
                                            </div>
                                            <div className='w-full h-full font-Outfit flex flex-col justify-end pb-5 items-center'>
                                                ...
                                                <div className=' h-[40%] w-[100px]' style={{backgroundColor:colorPicker3}}></div>
                                                <div className='h-4 w-[74%] mt-1 text-white text-sm bg-black flex justify-center items-center'>
                                                    <p>{option3}</p>
                                                </div>
                                            </div>
                                            <div className='w-full h-full font-Outfit flex flex-col justify-end pb-5 items-center'>
                                                ...
                                                <div className='bg-emerald-300 h-[30%] w-[100px]' style={{backgroundColor:colorPicker4}}></div>
                                                <div className='h-4 w-[74%] mt-1 text-white text-sm bg-black flex justify-center items-center'>
                                                    <p>{option4}</p>
                                                </div>
                                            </div>
...
export default PollPresentation
