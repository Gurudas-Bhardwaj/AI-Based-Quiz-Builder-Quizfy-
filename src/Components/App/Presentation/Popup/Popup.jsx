...
const Popup = ({ isVisible, value }) => {
    return (
        ...
        >
            {/* Popup value */}
            <div className='absolute top-[-40px] left-1/2 transform -translate-x-1/2 px-3 py-1 flex justify-center items-center rounded-2xl text-white bg-black font-Outfit font-semibold whitespace-nowrap z-10'>
