...
const PopUp = ({isVisible, value}) => {
    return (
        <div className={`flex-col gap-0 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0 flex' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
