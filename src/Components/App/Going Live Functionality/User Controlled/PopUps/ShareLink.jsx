...
const ShareLink = ({presentationId, onClose}) => {
    const [link, setLink] = useState(`https://quizifyai.me/Join/UserControlledQuiz/Live/${presentationId}`);
    const[show,setShow] = useState(false);

    useEffect(() => {
        setLink(`https://quizifyai.me/Join/UserControlledQuiz/Live/${presentationId}`);
    }, [presentationId]);
