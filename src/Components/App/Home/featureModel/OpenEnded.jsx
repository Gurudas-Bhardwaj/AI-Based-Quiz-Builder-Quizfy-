...
import background1 from "../../../../assests/Images/Background_Images/simpleBackground5.jpg"
import background2 from "../../../../assests/Images/Background_Images/simpleBackground4.jpg"
import background3 from "../../../../assests/Images/Background_Images/simpleBackground3.jpg"
        ...
        <div className=' bg-white w-[90%] sm:w-[80%] md:w-[78%]  h-[500px] border-2 border-white rounded-2xl '>
          <div className='w-full h-full flex flex-col'>
            ...
            <div className='w-full overflow-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 pl-8 pr-8'>
                ...
                <div className='flex flex-col gap-1'>
                    <NavLink to="/App/Presentation/OpenEnded" state={{backgroundImage : background1}} style={{backgroundImage: `url(${OpenEnded3})`,backgroundSize: 'cover', // or 'cover'
                        backgroundPosition: 'center',}}  className='h-40  w-full flex justify-center items-center border-2 border-stone-400 hover:border-indigo-400 transition-all cursor-pointer rounded-sm'>
                        
                    </NavLink>
                    <h1 className='font-Outfit pl-1'>Unique look </h1>
                </div>
                <div className='flex flex-col gap-1'>
                    <NavLink to="/App/Presentation/OpenEnded" state={{backgroundImage : background2}} style={{backgroundImage: `url(${OpenEnded2})`,backgroundSize: 'cover', // or 'cover'
                        backgroundPosition: 'center',}} className='h-40  w-full flex justify-center items-center border-2 border-stone-400 hover:border-indigo-400 transition-all cursor-pointer rounded-sm'>
                ...
                <div className='flex flex-col gap-1'>
                    <NavLink to="/App/Presentation/OpenEnded" state={{backgroundImage : background3}} style={{backgroundImage: `url(${OpenEnded1})`,backgroundSize: 'cover', // or 'cover'
                        backgroundPosition: 'center',}} className='h-40  w-full flex justify-center items-center border-2 border-stone-400 hover:border-indigo-400 transition-all cursor-pointer rounded-sm'>
