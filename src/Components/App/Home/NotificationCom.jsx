...
const NotificationCom = (props) => {
  return (
    <div>
      <div className='absolute z-10 transition-all bg-white rounded-lg top-9 p-3 -left-[330px]' style={{ "boxShadow": '0 2px 8px rgba(0, 0, 0, 0.4)', "display":props.display?"block":"none" }}>
            <div>
            <div className=' pl-2'>
