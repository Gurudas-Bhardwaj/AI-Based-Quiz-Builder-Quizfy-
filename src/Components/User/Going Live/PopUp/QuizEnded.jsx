            ...
            <div className="flex flex-col bg-white w-full max-w-lg shadow-2xl border border-white rounded-3xl p-8 animate-fadeIn items-center">
                <div className="flex flex-col justify-center items-center w-full">
                    ...
                    <div className="font-Outfit text-center text-stone-700 text-base md:text-lg px-2">
                        <p className="pt-4 pb-2">Quiz is Ended By the Admin!<br></br><span className="inline-block">Hope You Enjoyed the Experience</span></p>
                        <p className="text-sm text-stone-500">You can check the your history in the <span className="font-semibold text-indigo-500">history Session</span> in your Profile.</p>
                        <p className="text-sm text-stone-500 flex justify-center items-center  gap-1">Please <NavLink className="text-indigo-500 font-bold" to="/ReviewUs">Review Us</NavLink> and share your experience</p>
                    </div>
